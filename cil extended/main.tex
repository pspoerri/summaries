...
\input{01_dimensionality_reduction}
\input{02_svd}
\input{03_clustering}
\input{04_kmeans}
\input{05_mixture_models}
\input{06_multi_assignment_clustering}
\input{07_non_negative_matrix_factorisation}
\input{08_sparse_coding_classical_methods}
\input{09_overcomplete_dictionaries}
\input{10_dictonary_learning}
\input{appendix}
\end{document}
